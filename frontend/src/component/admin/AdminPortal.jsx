...
class AdminPortal extends Component {
  ...
  handlePortalSubmit = event => {
    ...
    //  let body= "debru";
    axios
      .post((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/admin/portal", body, {
        headers: {
  ...
  handlePortalEditUpdate = (info, formData1) => {
    ...
    axios
      .put((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/admin/portal/" + info["ID"], body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
      })
