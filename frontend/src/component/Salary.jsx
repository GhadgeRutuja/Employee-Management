...
class Salary extends Component {
  ...
  handleSalarySubmit = event => {
        ...
        // TerminateDate: { type: Date },
          ...
          axios
            .post((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/salary/"+event.target[0].value, body, {
              headers: {
...
console.log("eeeeeeeeeeeeeeeeeeeeddddddddddddddddddddddddd")
  ...
  // TerminateDate: { type: Date },
    ...
    axios
      .put(
        (process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/salary/" + info["salary"][0]["_id"],
        body, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
