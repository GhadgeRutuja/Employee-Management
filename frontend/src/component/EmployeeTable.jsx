...
class AdminEmployeeTable extends Component {
  ...
  loadEmployeeData = () => {
    axios
      .get((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/employee", {
        headers: {
  ...
  onEmployeeDelete = e => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      ...
      // axios
      //   .delete((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/employee/" + e, {
      //     headers: {
      //       authorization: localStorage.getItem("token") || ""
      //     }
      //   })
  ...
  renderActions(params) {
    return (
      <div style={{ display: 'flex', gap: '10px', alignItems: 'center', height: '100%' }}>
        {this.renderInfoButton(params)}
        {this.renderEditButton(params)}
