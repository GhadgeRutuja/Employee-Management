...
class Education extends Component {
  ...
  handleEducationSubmit = event => {
    ...
    axios
      .post((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/education/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleEducationEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        (process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/education/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
