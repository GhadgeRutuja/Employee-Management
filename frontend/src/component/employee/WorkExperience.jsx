...
class WorkExperience extends Component {
  ...
  handleWorkExperienceSubmit = event => {
    ...
    axios
      .post((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/work-experience/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleWorkExperienceEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        (process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/work-experience/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
