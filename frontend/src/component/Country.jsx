...
class Country extends Component {
  ...
  handleCountrySubmit = event => {
    ...
    //  let body= "debru";
    axios
      .post((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/country", body, {
        headers: {
  ...
  handleCountryEditUpdate = (info, newInfo) => {
    ...
    axios
      .put((process.env.REACT_APP_API_URL || "http://localhost:4000") + "/api/country/" + info["_id"], body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
      })
